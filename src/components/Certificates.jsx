...
// import Certificate1 from '../assets/images/01.jpeg'
// import Certificate2 from '../assets/images/02.jpg'
// import Certificate3 from '../assets/images/03.jpg'
// import Certificate4 from '../assets/images/04.jpg'
// import Certificate5 from '../assets/images/05.jpg'
...
//       issuer: "Digital Dream Web",
//       date: "2025",
//       description: "Completed a 3 month comprehensive course in HTML, CSS, Bootstrap, JavaScript, and Responsive Web Design. Gained hands-on experience building modern, reponsive websites.",
//       credentialLink: Certificate1, 
...
//       issuer: "Lets Upgrade",
//       date: "2025",
//       description: "Completed a 3 day intensive bootcamp focused on mastering responsive design principles and modern HTML & CSS techniques.",
//       credentialLink: Certificate2,
//       skills: ["CSS3", "HTML5"]
//     },
//     {
//       id: 3,
//       title: "React JS Mastery Course Evaluation Quiz",
//       issuer: "ProProfs Quiz Maker",
//       date: "2025",
//       description: "Certificate of Achievement awarded for successfully completing the React JS Mastery Course Evaluation Quiz with a score of 90/100.",
//       credentialLink: Certificate3,
...
//       date: "2025",
//       description: "Gained hands-on experience by working on real-world projects, focusing on building responsive web solutions and applying effective problem-solving to complex technical challenges.",
//       credentialLink: Certificate4,
//       skills: ["HTML5", "CSS3", "Bootstrap", "Javascript"]
//     },
//     {
//       id: 5,
//       title: "Code Canvas Tech Competition ",
//       issuer: "Dep Computer Science AWK University Mardan",
//       date: "2025",
//       description: "Awarded Certificate of Participation for securing 4th position in Code Canvas ’25, a competitive programming event held at AWKUM University",
//       credentialLink: Certificate5,
//       skills: ["Data Structure", "LeetCode", "C++"]
//     }
//   ];
  ...
  return (
    <section id="certificates" className="py-24 bg-slate-900 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-5xl font-bold text-white mb-4">
            My <span className="text-[#38bdf8]">Certificates & Achievements</span>
          </h2>
          <div className="w-24 h-1 bg-[#38bdf8] mx-auto"></div>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {certificatesData.map((cert, index) => (
            <motion.div
              ...
              onHoverEnd={() => setHoveredCert(null)}
              whileHover={{ y: -15 }}
              onClick={() => openCertificate(cert.credentialLink)}
              className="group relative bg-[#020617] rounded-xl overflow-hidden border border-slate-800 hover:border-[#38bdf8] transition-all duration-300 cursor-pointer"
            >
              {/* Certificate Image Header */}
              <div className="h-48 bg-gradient-to-br from-[#38bdf8]/20 to-cyan-500/10 relative overflow-hidden">
                <motion.img
                  src={cert.image}
                  alt={cert.title}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#020617] via-transparent to-transparent opacity-40 group-hover:opacity-20 transition-opacity duration-300" />
                
                {/* View Full Certificate overlay on hover - LIGHTER */}
                <div className="absolute inset-0 bg-[#38bdf8]/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 backdrop-blur-sm">
                  <div className="text-center text-white">
                    <motion.div
                      animate={{ scale: [1, 1.1, 1] }}
                      transition={{ duration: 1.5, repeat: Infinity }}
                    >
                      <FaSearchPlus className="text-4xl mx-auto mb-2" />
                    </motion.div>
                    <p className="font-bold text-lg">Click to View Full</p>
                  </div>
                </div>
              </div>
