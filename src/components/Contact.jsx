...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const serviceID = 'service_1ktr5mv';  // Get from EmailJS dashboard
    const templateID = 'template_vrabpa9'; // Get from EmailJS dashboard
    const publicKey = '3_KtLzIkmhuhcUDzW';   // Get from EmailJS dashboard
            ...
            <form ref={form} onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#020617] border border-slate-800 rounded-lg text-white focus:outline-none focus:border-[#38bdf8] transition-colors disabled:opacity-50"
                  placeholder="Your name"
                />
              </motion.div>
              ...
              >
                ...
                <textarea
                  ...
                  disabled={isSubmitting}
                  rows="5"
                  className="w-full px-4 py-3 bg-[#020617] border border-slate-800 rounded-lg text-white focus:outline-none focus:border-[#38bdf8] transition-colors resize-none disabled:opacity-50"
                  placeholder="Your message..."
                />
              </motion.div>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                disabled={isSubmitting}
                className="w-full px-8 py-4 bg-[#38bdf8] text-slate-900 font-bold rounded-lg hover:bg-cyan-400 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <>
