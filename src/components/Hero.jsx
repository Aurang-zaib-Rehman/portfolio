...
//                     whileTap={{ scale: 0.9 }}
//                     className="w-14 h-14 rounded-full bg-slate-800/90 backdrop-blur-sm border border-[#38bdf8]/30 flex items-center justify-center text-white shadow-lg hover:shadow-[#38bdf8]/50 transition-all duration-300 group"
//                     style={{
//                       boxShadow: `0 0 20px ${social.color}40`
//                     }}
//                   >
//                     <Icon className="text-2xl group-hover:text-[#38bdf8] transition-colors duration-300" />
//                   </motion.a>
//                 );
//               })}
//             </motion.div>
...
//           whileTap={{ scale: 0.9 }}
//           className="w-16 h-16 rounded-full bg-gradient-to-r from-[#38bdf8] to-purple-600 flex items-center justify-center text-white shadow-2xl shadow-[#38bdf8]/50 hover:shadow-[#38bdf8]/70 transition-all duration-300"
//         >
//           <AnimatePresence mode="wait">
//             {showSocial ? (
//               <motion.div
